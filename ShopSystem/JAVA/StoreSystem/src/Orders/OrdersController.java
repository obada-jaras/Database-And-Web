...
public class OrdersController implements Initializable {
    ...
    @FXML
    private TableColumn<CartItem, String> cSize;
    @FXML
    private TableColumn<CartItem, String> cColor;
    @FXML
    ...
    @FXML
    private TableColumn<CartItem, String> cSize1;
    @FXML
    private TableColumn<CartItem, String> cColor1;
    @FXML
...
//			e.printStackTrace();
			...
			filteredData.setPredicate(item -> {
				...
				if (item.getModel().toLowerCase().indexOf(lowerCaseFilter) != -1 ) {
					...
					return true; // Filter matches last name.
				     ...
				     return true;
				} else if (item.getSize().toLowerCase().indexOf(lowerCaseFilter) != -1) {
					return true; // Filter matches last name.
				} else if (item.getColor().toLowerCase().indexOf(lowerCaseFilter) != -1) {
					return true; // Filter matches last name.
				}
				else  
    ...
    private void updateCartTable() {
		...
		cSize.setCellValueFactory(new PropertyValueFactory<CartItem, String>("size"));
		cColor.setCellValueFactory(new PropertyValueFactory<CartItem, String>("color"));
    ...
    public void updateCartTable1() {
		...
		cSize1.setCellValueFactory(new PropertyValueFactory<CartItem, String>("size"));
		cColor1.setCellValueFactory(new PropertyValueFactory<CartItem, String>("color"));
    ...
    public void addItemToCart(ActionEvent event) {
    	...
    	CartItem item = new CartItem(CLM_iID.getCellData(iIndex),
				    				CLM_iModel.getCellData(iIndex),
				    				CLM_iDescription.getCellData(iIndex),
				    				CLM_iSize.getCellData(iIndex),
				    				CLM_iColor.getCellData(iIndex),
				    				CLM_iSelling.getCellData(iIndex));
