...
<?php
   function availableInfo($fName, $lName, $idN, $email, $mobileNo){
         ...
         <form method="post" action="">
            ...
            <?php
               if(isset($_POST['checkInfo'])){
                  ...
                  if (availableInfo($fName, $lName, $idN, $email, $mobileNo)){
                     echo $eAccountForm;
                  }
               }
                     ...
                     if (availableEAccount($un, $pw)){
                        ...
                        if (count($result) == 0){
                           ...
                           if (count($result) == 0){
                              ...
                              $sql = "INSERT INTO Customer (id, oName, DateOfBirth, EmailAddress, MobileNumbers, TelephoneNumbers, AddressID, UserName, oPassword) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);";    //insert new customer
                              $pdo->prepare($sql)->execute([$idN, $fName." ".$lName, $dof, $email, $mobileNo, $telephoneN, $addressID, $un, $pw]);                                                               //insert new customer

                              echo "Registration Completed...<br>";
                              echo "Username: ".$un."<br>";
                              echo "CustomerID: ".$idN."<br>";
