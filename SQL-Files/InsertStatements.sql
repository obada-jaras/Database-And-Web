...
INSERT INTO Item(ModelNumber, PurchasePrice, SellingPrice, ItemType, SupplierID, Size, Color, Quantity) VALUES
	...
	('12-MDL-9943', 12.0, 29.99, 16, 102, 'OneSize', 'YELLOW', 1),
    ('LLT207', 22.5, 49.99, 11, 102, 'OneSize', 'WHITE', 7),
    ('LLT207', 22.5, 49.99, 11, 102, 'OneSize', 'BLUE', 4),
    ('LLT207', 22.5, 49.99, 11, 102, 'OneSize', 'BLACK', 9),
    ('LLT207', 22.5, 49.99, 11, 102, 'OneSize', 'RED', 2),
    ('TNT101', 95, 140, 15, 102, 'S', 'BLACK', 4),
    ('TNT101', 95, 140, 15, 102, 'M', 'BLACK', 5);
